...
from analysis_engine.pipeline import analyze_dc_record, build_masters_from_trials
...
def run_demo(n_trials: int = 30, seed: int = 0) -> list[dict]:
    ...
    for _ in range(n_trials):
        ...
        trial_stats.append(compute_stats(sig.channels["vib_a"]))

...
## 2026-07-29 15:11 UTC — GUI scaffold merged (PR #1)
**Commits:** `2d5ace3` (scaffold add), `3b92fa4` (merge)

Second Claude account working in parallel on `claude/gui-scaffold` added:

- `qt-app/`: bare PySide6 desktop application skeleton, design-tokens wired in,
  placeholder screens with TODO banners for Master Entry, Live Display, Report,
  and SPC screens.
- `web-frontend/`: Tailwind/React shell, matching placeholder screens for the
  web UI.

No data wiring — layout/navigation skeletons only, ready for M1 to wire against
the FastAPI backend. Merged into this branch via PR #1 with zero conflicts.
